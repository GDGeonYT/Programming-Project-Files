                ...
                <form action="P_Edit.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-2">
                            ...
                            <input type="text" class="form-control" id="P_SKU" name="P_SKU"  maxlength="12"  required />
                        </div>
                        <div class="col-lg-12 mb-2">
                        ...
                        <div class="col-lg-12 mb-2">
                            <label for="P_ID" class="form-label"></label>
                            <input type="hidden" class="form-control" id="P_ID" name="P_ID" required />
                        </div>
                    </div>
                    <hr/>
                    <div class="row">
